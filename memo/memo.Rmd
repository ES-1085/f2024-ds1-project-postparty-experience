...
Postpartum_support_type <- Postpartum_by_child |>
  mutate(support_type = ifelse(support_type == "In-home help with tasks like laundry, cooking, cleaning, and child care", "In-home help with care tasks", support_type))
```
